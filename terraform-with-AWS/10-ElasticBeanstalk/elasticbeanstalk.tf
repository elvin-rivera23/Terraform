...
# environments, e.g. test, prod, etc.
resource "aws_elastic_beanstalk_environment" "app-prod" {
  ...
  # instances can communicate in another AZ
  setting {
    namespace = "aws:elb:loadbalancer"
    name      = "CrossZone"
    value     = "true"
  }
  # batch size for updates/upgrades
  setting {
...
# cd /vagrant
# git clone github link/eb-php-example
# cd eb-php-example/
# ls
# cat index.PHP
# eb init
//  choose your AWS_REGION
# eb deploy
